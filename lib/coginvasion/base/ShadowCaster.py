# Embedded file name: lib.coginvasion.base.ShadowCaster
...
class ShadowCaster(DirectObject):
    ...
    def enable(self):
        ...
        self.shadowLens.setFilmSize(240, 240)
    ...
    def createBuffer(self):
        if not base.win.getGsg():
            ...
            self.shadowBuffer = base.win.makeTextureBuffer('shadow', 4096, 4096, tex=self.shadowTex)
