# Embedded file name: lib.coginvasion.suit.SuitBoss
"""
...
class SuitBoss:
    ...
    def flyAwayToNewSpot(self, path_key, task):
        ...
        suitTrack = ProjectileInterval(self.suitbase, startPos=self.suitbase.getPos(render), endPos=CIGlobals.SuitSpawnPoints[self.suitbase.hood][self.spot], gravityMult=0.25, duration=3.5)
        suitTrack.start()
