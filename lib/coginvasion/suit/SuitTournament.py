# Embedded file name: lib.coginvasion.suit.SuitTournament
"""
...
class SuitTournament:
    ...
    round_difficulties = [range(1, 5), range(5, 9), range(9, 13)]
    round_sizes = ['large', 'large', 'large']
