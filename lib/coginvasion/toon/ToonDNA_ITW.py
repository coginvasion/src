# Embedded file name: lib.coginvasion.toon.ToonDNA_ITW
"""
...
class ToonDNA:
    ...
    clothesColorDNA2clothesColor = {'00': LVecBase4f(0.933594, 0.265625, 0.28125, 1),
    ...
    skirtDNA2skirt = {'00': ('phase_3/maps/desat_skirt_1.jpg', 1),
    ...
    def generateDNAStrandWithCurrentStyle(self):
        ...
        gloveColor = '00'
        strand = '%s/%s/%s/%s/%s/%s/%s/%s/%s/%s/%s/%s/%s/%s/%s' % (gender,
         animal,
         head,
         headcolor,
         torso,
