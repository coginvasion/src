...
class DistributedHQNPCToon(DistributedNPCToon.DistributedNPCToon):
    ...
    def makePickableQuests(self, list):
        ...
        self.questFrame = DirectFrame(parent=base.a2dLeftCenter, relief=None, pos=(0.5, 0, 0), geom=DGG.getDefaultDialogGeom(), geom_color=Vec4(0.8, 0.6, 0.4, 1), geom_scale=(1.85, 1, 0.9), geom_hpr=(0, 0, -90))
        self.questBtns = []
