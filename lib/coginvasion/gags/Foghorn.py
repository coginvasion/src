# Embedded file name: lib.coginvasion.gags.Foghorn
"""
...
class Foghorn(SoundGag):
    ...
    def __init__(self):
        SoundGag.__init__(self, CIGlobals.Foghorn, 'phase_5/models/props/fog_horn.bam', 50, GagGlobals.FOG_APPEAR_SFX, GagGlobals.FOG_SFX, soundRange=40, hitSfx=None)
