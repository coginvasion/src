# Embedded file name: lib.coginvasion.gags.Opera
"""
...
class Opera(SoundGag):
    ...
    def __init__(self):
        SoundGag.__init__(self, CIGlobals.Opera, 'phase_5/models/props/singing.bam', 90, appearSfx=GagGlobals.FOG_APPEAR_SFX, soundSfx=GagGlobals.OPERA_SFX, soundRange=50, hitSfx=GagGlobals.OPERA_HIT_SFX)
