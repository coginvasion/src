# Embedded file name: lib.coginvasion.gags.Aoogah
"""
...
class Aoogah(SoundGag):
    ...
    def __init__(self):
        SoundGag.__init__(self, CIGlobals.Aoogah, 'phase_5/models/props/aoogah.bam', 16, GagGlobals.AOOGAH_APPEAR_SFX, GagGlobals.AOOGAH_SFX, soundRange=30, hitSfx=None)
