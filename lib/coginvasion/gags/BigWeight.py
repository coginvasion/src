# Embedded file name: lib.coginvasion.gags.BigWeight
"""
...
class BigWeight(DropGag):
    ...
    def __init__(self):
        DropGag.__init__(self, CIGlobals.BigWeight, 'phase_5/models/props/weight-mod.bam', 'phase_5/models/props/weight-chan.bam', 45, GagGlobals.WEIGHT_DROP_SFX, GagGlobals.WEIGHT_MISS_SFX, 1, 1)
