# Embedded file name: lib.coginvasion.gags.ChargeUpGag
"""
...
class ChargeUpGag:
    ...
    def start(self, avatar):
        ...
        if self.avatar == base.localAvatar:
            self.chargeUpSpot = ChargeUpSpot(self.avatar, self.selectionRadius, self.minDistance, self.maxDistance, self.shadowScale, self.maxCogs)
