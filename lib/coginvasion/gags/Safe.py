# Embedded file name: lib.coginvasion.gags.Safe
"""
...
class Safe(DropGag):
    ...
    def __init__(self):
        DropGag.__init__(self, CIGlobals.Safe, 'phase_5/models/props/safe-mod.bam', 'phase_5/models/props/safe-chan.bam', 60, GagGlobals.SAFE_DROP_SFX, GagGlobals.SAFE_MISS_SFX, 1, 1)
