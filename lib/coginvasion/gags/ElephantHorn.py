# Embedded file name: lib.coginvasion.gags.ElephantHorn
"""
...
class ElephantHorn(SoundGag):
    ...
    def __init__(self):
        SoundGag.__init__(self, CIGlobals.ElephantHorn, 'phase_5/models/props/elephant.bam', 21, GagGlobals.ELEPHANT_APPEAR_SFX, GagGlobals.ELEPHANT_SFX, soundRange=35, hitSfx=None)
