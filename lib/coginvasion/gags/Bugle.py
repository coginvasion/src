# Embedded file name: lib.coginvasion.gags.Bugle
"""
...
class Bugle(SoundGag):
    ...
    def __init__(self):
        SoundGag.__init__(self, CIGlobals.Bugle, 'phase_5/models/props/bugle.bam', 11, GagGlobals.BUGLE_APPEAR_SFX, GagGlobals.BUGLE_SFX, soundRange=25, hitSfx=None)
