# Embedded file name: lib.coginvasion.npc.MickeyNPCBase
"""
...
class MickeyNPCBase:
    ...
    def startMickeyConversation(self):
        ...
        cchar_turnInt = self.mickey.hprInterval(0.5, Point3(self.turnHpr), startHpr=self.currentHpr)
        cchar_turnInt.start()
    ...
    def handleNewAvatar(self, val):
        if val not in self.nearbyToons:
