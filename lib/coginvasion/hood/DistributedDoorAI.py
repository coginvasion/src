# Embedded file name: lib.coginvasion.hood.DistributedDoorAI
...
class DistributedDoorAI(DistributedObjectAI.DistributedObjectAI):
    ...
    def __init__(self, air, block, toZone, doorType = 1, doorIndex = 0):
        ...
        self.rightDoorStates = ['closed',
         'open',
         'closing',
         'opening']
        self.leftDoorStates = ['closed',
         'open',
         'closing',
         'opening']
        self.leftDoorState = ''
    ...
    def _rightCloseToOpenDone(self, task):
        ...
        self.rightDoorOpenTask = base.taskMgr.doMethodLater(self.OPEN_TIME, self._rightOpenDone, self.uniqueName('rightOpenDone'))

    def _rightOpenDone(self, task):
        self.__removeRightOpen()
        self.b_setRightDoorState('closing')
        self.rightOpenToCloseTask = base.taskMgr.doMethodLater(self.OPEN_TO_CLOSE_TIME, self._rightOpenToCloseDone, self.uniqueName('rightOpenToCloseDone'))
    ...
    def requestEnter(self):
        ...
        self.__removeRightOpen()
        self.__removeRightOpenToClose()
        self.rightDoorCloseToOpenTask = base.taskMgr.doMethodLater(self.CLOSE_TO_OPEN_TIME, self._rightCloseToOpenDone, self.uniqueName('rightCloseToOpenDone'))

    def _leftCloseToOpenDone(self, task):
        self.__removeLeftCloseToOpen()
        self.b_setLeftDoorState('open')
        self.leftDoorOpenTask = base.taskMgr.doMethodLater(self.OPEN_TIME, self._leftOpenDone, self.uniqueName('leftOpenDone'))

    def _leftOpenDone(self, task):
        self.__removeLeftOpen()
        self.b_setLeftDoorState('closing')
        self.leftOpenToCloseTask = base.taskMgr.doMethodLater(self.OPEN_TO_CLOSE_TIME, self._leftOpenToCloseDone, self.uniqueName('leftOpenToCloseDone'))
    ...
    def requestExit(self):
        ...
        self.__removeLeftOpen()
        self.__removeLeftOpenToClose()
        self.leftDoorCloseToOpenTask = base.taskMgr.doMethodLater(self.CLOSE_TO_OPEN_TIME, self._leftCloseToOpenDone, self.uniqueName('leftCloseToOpenDone'))