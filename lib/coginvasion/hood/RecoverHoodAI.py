# Embedded file name: lib.coginvasion.hood.RecoverHoodAI
"""
...
class RecoverHoodAI(HoodAI):
    ...
    maxIceCreams = 15
    iceCreamLocs = [Point3(24.77, 0.0, 11.71),
     Point3(10.99, 28.6, 4.25),
     Point3(51.23, 6.87, 8.0),
     Point3(44.5, -19.36, 8.46),
     Point3(92.33, -19.36, 0.02),
     Point3(92.33, 14.32, 4.25),
     Point3(8.05, -50.13, 4.16),
     Point3(49.36, -50.13, 5.1),
     Point3(82.02, -71.27, 0.0),
     Point3(22.85, 71.0, -0.01),
     Point3(47.72, 53.37, 0.02),
     Point3(91.21, 52.57, 0.02),
     Point3(1.65, 65.08, 4.79),
     Point3(-41.37, 62.3, 0.02),
     Point3(-33.17, 29.78, 2.33),
     Point3(-57.35, 14.62, 2.36),
     Point3(-57.35, -66.8, 3.95)]
