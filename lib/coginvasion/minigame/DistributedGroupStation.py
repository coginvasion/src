# Embedded file name: lib.coginvasion.minigame.DistributedGroupStation
...
class DistributedGroupStation(GroupStation.GroupStation, DistributedObject):
    ...
    numPlayers2SphereRadius = {3: 13,
     4: 12,
     8: 13.5}
    numPlayers2SphereSx = {3: 1.0,
     4: 1.15,
     8: 1.15}
    numPlayers2SphereSy = {3: 1.0,
     4: 0.8,
     8: 1.0}
    numPlayers2SphereY = {3: 0.0,
     4: 5.0,
     8: 5.0}
    numPlayers2CamPos = {3: (0, 30.0, 22.5),
     4: (0, 30.0, 22.5),
     8: (0, 35.0, 22.5)}
    ...
    def createStationAbortGui(self):
        ...
        self.abortBtn = DirectButton(text='Leave', geom=(qt_btn.find('**/QuitBtn_UP'), qt_btn.find('**/QuitBtn_DN'), qt_btn.find('**/QuitBtn_RLVR')), relief=None, scale=1.2, text_scale=0.055, pos=(0, 0, 0.85), text_pos=(0, -0.01), geom_scale=(0.8, 1, 1), command=self.d_requestAbort)
        return
