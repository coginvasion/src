...
GuardDialog = {'arrest': ['Get your hands over your head!',
 ...
 'disregard': ['Hmm, I guess it was nothing.',
               'I swear I saw something.',
               'I swear I heard something.',
               'My mind must be playing tricks on me.',
               'Hmm, nothing there.'],
 'somethingInSight': ['Who goes there?!',
                      'Whoa, what was that?',
                      'I think I just saw something.',
                      'Did I just see someone?',
                      'Did I just see a Toon?'],
 'spot': ["It's a Toon! Hey, stop right there!",
 ...
 'chase': ["Like my face? It's the last thing you'll see.",
 ...
 'shot': ["I'm hit!",
          ...
          'Oof!',
          'Oof! 11-99!'],
 'heard': ['What was that noise?',
           'Am I the only one who hears that?',
           'Did you hear that too?',
           'Whoa, what was that?',
           'Whoa, I think I just heard something...'],
 'suspect': ["OK, there's gotta be someone around here.",
...
FactoryGuardPoints = {'1': [Point3(50.8605651855, 493.650238037, 28.7250232697), Vec3(313.025054932, 0.0, 0.0)],
 '2': [Point3(50.5030555725, 479.770721436, 28.7250232697), Vec3(270.0, 0.0, 0.0)],
 '3': [Point3(-24.8482875824, 498.838745117, 28.7250232697), Vec3(0.0, 0.0, 0.0)],
 '4': [Point3(-24.8482875824, 446.4090271, 28.7252674103), Vec3(180.0, 0.0, 0.0)],
 '5': [Point3(-41.4686851501, 446.4090271, 28.7252674103), Vec3(90.0, 0.0, 0.0)],
 '6': [Point3(-7.23602104187, 434.330535889, 28.7252674103), Vec3(90.0, 0.0, 0.0)],
 '7': [Point3(17.745639801, 434.330535889, 28.7252674103), Vec3(270.0, 0.0, 0.0)],
 '8': [Point3(-6.85039520264, 434.566162109, 43.7142791748), Vec3(180.0, 0.0, 0.0)],
 '9': [Point3(1.79736101627, 434.566162109, 43.7142791748), Vec3(180.0, 0.0, 0.0)],
 '10': [Point3(10.3381643295, 434.566162109, 43.7142791748), Vec3(180.0, 0.0, 0.0)],
 '11': [Point3(19.1219005585, 434.566162109, 43.7154998779), Vec3(180.0, 0.0, 0.0)],
 '12': [Point3(43.9076843262, 449.104980469, 28.724779129), Vec3(270.0, 0.0, 0.0)],
 '13': [Point3(31.5120067596, 445.849884033, 28.724779129), Vec3(90.0, 0.0, 0.0)],
 '14': [Point3(76.6376647949, 539.907409668, 43.7259979248), Vec3(270.0, 0.0, 0.0)],
 '15': [Point3(-64.5058364868, 539.907409668, 43.7259979248), Vec3(90.0, 0.0, 0.0)],
 '16': [Point3(-19.6063995361, 131.088729858, 3.7260093689), Vec3(90.0, 0.0, 0.0)],
 '17': [Point3(63.3582801819, 131.088729858, 3.7260093689), Vec3(270.0, 0.0, 0.0)],
 '18': [Point3(127.58114624, 268.98614502, 8.68414115906), Vec3(308.659820557, 0.0, 0.0)],
 '19': [Point3(92.5095977783, 232.670257568, 8.68414115906), Vec3(152.916442871, 0.0, 0.0)],
 '20': [Point3(189.383132935, 233.027069092, 8.68487358093), Vec3(180.0, 0.0, 0.0)],
 '21': [Point3(205.738693237, 340.856567383, 18.7260017395), Vec3(270.0, 0.0, 0.0)],
 '22': [Point3(144.820892334, 465.931915283, 23.7259998322), Vec3(138.037338257, 0.0, 0.0)],
 '23': [Point3(-65.8107452393, 480.288360596, 23.7259998322), Vec3(270.0, 0.0, 0.0)],
 '24': [Point3(-313.754058838, 528.80090332, 23.7295665741), Vec3(0.0, 0.0, 0.0)],
 '25': [Point3(-343.322021484, 596.249816895, 23.7386016846), Vec3(90.0, 0.0, 0.0)],
 '26': [Point3(-404.657501221, 552.570800781, 23.7461681366), Vec3(180.0, 0.0, 0.0)],
 '27': [Point3(-538.390075684, 595.941772461, 8.72601032257), Vec3(90.0, 0.0, 0.0)],
 '28': [Point3(-515.727783203, 370.884094238, 8.72601032257), Vec3(90.0, 0.0, 0.0)],
 '29': [Point3(-184.767532349, 370.884094238, 18.7259998322), Vec3(90.0, 0.0, 0.0)],
 '30': [Point3(-99.2514801025, 341.364715576, 18.7259998322), Vec3(270.0, 0.0, 0.0)],
 '31': [Point3(-158.564758301, 295.215332031, 18.7259998322), Vec3(270.0, 0.0, 0.0)]}
FactoryWayPointData = {'24': ['25',
        '26',
        '21',
        '23'],
 '25': ['24', '26', '23'],
 ...
 '78': ['82',
        ...
        '77',
        '76']}
JellybeanBarrelPoints = [[Point3(-39.7513237, 492.480865479, 28.7250213623), Vec3(45.0, 0.0, 0.0)],
