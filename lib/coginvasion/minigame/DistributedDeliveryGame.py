# Embedded file name: lib.coginvasion.minigame.DistributedDeliveryGame
...
class DistributedDeliveryGame(DistributedMinigame):
    ...
    def enterPlay(self):
        ...
        self.brLabel = OnscreenText(text='', parent=base.a2dTopRight, fg=(1, 1, 1, 1), shadow=(0, 0, 0, 1), pos=(-0.1, -0.1, 0), align=TextNode.ARight)
        self.bdLabel = OnscreenText(text='', parent=base.a2dTopLeft, fg=(1, 1, 1, 1), shadow=(0, 0, 0, 1), pos=(0.1, -0.1, 0), align=TextNode.ALeft)
        self.bsLabel = OnscreenText(text='', parent=base.a2dTopLeft, fg=(1, 1, 1, 1), shadow=(0, 0, 0, 1), pos=(0.1, -0.2, 0), align=TextNode.ALeft)
