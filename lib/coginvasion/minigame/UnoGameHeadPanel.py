# Embedded file name: lib.coginvasion.minigame.UnoGameHeadPanel
"""
...
class UnoGameHeadPanel:
    ...
    def generate(self, gender, head, headtype, color, doId, name):
        ...
        cardCount = DirectLabel(text='0', parent=container, text_scale=0.15, text_fg=(1, 1, 1, 1), text_shadow=(0, 0, 0, 1), relief=None, pos=(0.26, 0, -0.28))
