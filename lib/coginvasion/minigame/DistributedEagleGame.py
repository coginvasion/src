# Embedded file name: lib.coginvasion.minigame.DistributedEagleGame
...
def getIval(text, duration1, duration2, duration3):
    ival = Sequence(LerpPosInterval(text, duration=duration1, pos=(0, 0, 0.3), startPos=(0, 0, 1.5), blendType='easeIn'), LerpPosInterval(text, duration=duration2, pos=(0.0, 0, -0.2), startPos=(0, 0, 0.3)), LerpPosInterval(text, duration=duration3, pos=(0, 0, -1.5), startPos=(0, 0, -0.2), blendType='easeOut'))
    return ival
