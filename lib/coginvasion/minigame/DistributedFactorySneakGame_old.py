# Embedded file name: lib.coginvasion.minigame.DistributedFactorySneakGame_old
"""
...
class DistributedFactorySneakGame(DistributedToonFPSGame.DistributedToonFPSGame):
    ...
    def enterCountdown(self):
        ...
        self.countdownSeq = Sequence(Func(playSfx, 0), Func(text.setText, '5'), Wait(1), Func(playSfx, 1), Func(text.setText, '4'), Wait(1), Func(playSfx, 2), Func(text.setText, '3'), Wait(1), Func(playSfx, 3), Func(text.setText, '2'), Wait(1), Func(playSfx, 4), Func(text.setText, '1'), Wait(1), Func(text.setText, 'SNEAK!'), Func(self.whistleSfx.play), Func(self.fsm.request, 'play'), Wait(1), Func(text.destroy))
