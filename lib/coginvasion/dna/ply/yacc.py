# Embedded file name: lib.coginvasion.dna.ply.yacc
__version__ = '3.4'
__tabversion__ = '3.2'
yaccdebug = 1
...
class Grammar(object):
    ...
    def set_precedence(self, term, assoc, level):
        if not self.Productions == [None]:
            ...
            raise assoc not in ('left', 'right', 'nonassoc') and GrammarError("Associativity must be one of 'left','right', or 'nonassoc'")
